        ...
        <Container>
          <FadeIn>
            <div className="mx-auto max-w-3xl text-center">
              <Badge
                variant="secondary"
                className="mb-5 px-3 py-1 text-xs font-medium"
              >
              ...
              <blockquote className="mt-6 mx-auto max-w-xl rounded-xl bg-card ring-1 ring-foreground/10 p-5 text-left">
                <p className="text-sm italic text-muted-foreground leading-relaxed">
                  &ldquo;Doing good protects against an evil end, and secret
                  charity extinguishes the wrath of the Lord.&rdquo;
                </p>
              ...
              <p className="mt-5 text-sm text-muted-foreground max-w-xl mx-auto">
                For anyone who wishes to support or contribute to these
                initiatives — helping hands for those in need.
              </p>
